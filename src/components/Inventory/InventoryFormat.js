// src/components/Inventory/inventoryFormat.js
//
// Shared helpers for the Inventory frontend.
// Keeps money formatting, unit display, and "is this stock okay?" logic
// in one place so every inventory screen agrees on what "Running Low" means.
